...
Provide a reusable `@MappedSuperclass` for domain entities that require soft-delete support. Centralizes the `deletedAt` field definition to eliminate duplication across entities and enable consistent soft-delete behavior.
