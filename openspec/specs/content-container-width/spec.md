...
The page content, navbar content, and footer content SHALL be constrained to a centered container with horizontal margins, while preserving full-width background bars for the navbar and footer.
