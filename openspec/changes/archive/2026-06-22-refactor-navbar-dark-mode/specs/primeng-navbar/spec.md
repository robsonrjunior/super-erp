...
- **THEN** a PrimeNG popup menu appears listing all entity links (Tenant, Country, State, City, Supplier, Customer, Person, Company, Product, Raw Material, Warehouse, Stock Movement, Sale, Sale Item)
...
- **THEN** the Admin menu button is visible and shows admin links (Authority, User Management, Metrics, Health, Configuration, Logs, API)
