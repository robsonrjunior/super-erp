...
import { SaleItemDeleteDialog } from './sale-item-delete-dialog';

describe('SaleItem Management Delete Component', () => {
  let comp: SaleItemDeleteDialog;
  let fixture: ComponentFixture<SaleItemDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SaleItemDeleteDialog);
