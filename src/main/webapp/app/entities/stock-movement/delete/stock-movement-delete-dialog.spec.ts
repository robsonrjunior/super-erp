...
describe('StockMovement Management Delete Component', () => {
  let comp: StockMovementDeleteDialog;
  let fixture: ComponentFixture<StockMovementDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(StockMovementDeleteDialog);
