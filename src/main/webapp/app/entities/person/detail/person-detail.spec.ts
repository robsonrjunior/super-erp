...
describe('Person Management Detail Component', () => {
  ...
  describe('OnInit', () => {
    it('should load person on init', async () => {
      ...
      const instance = await harness.navigateByUrl('/', PersonDetail);

      // THEN
      expect(instance.person()).toEqual(expect.objectContaining({ id: 8101 }));
    });
  });
